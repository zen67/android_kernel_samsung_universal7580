...
# export ANDROID_VERSION=7
# export ANDROID_MAJOR_VERSION=7.0

export BUILD_CROSS_COMPILE=/home/zenon/android/aarch64-linux-android-4.9/bin/aarch64-linux-android-

export CROSS_COMPILE=$BUILD_CROSS_COMPILE
export BUILD_JOB_NUMBER=`grep processor /proc/cpuinfo|wc -l`

export KERNEL_VERSION="ZKernel-v.1.0"
export KBUILD_BUILD_VERSION="0"

KERNEL_DEFCONFIG=a5xelte_defconfig
